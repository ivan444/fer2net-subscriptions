...
urlpatterns = patterns('',
  ...
  url(r'^payment/superuser/delete$', 'subscriptions.views.superuserDeletePayment', name='superuser_delete_payment'),
  url(r'^payment/superuser/delete/(?P<sid>[\d ]+)$', 'subscriptions.views.superuserDeletePayment', name='superuser_delete_payment'),
